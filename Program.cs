...
{
    public static SLLQueue queue = new SLLQueue();
    ...
    {
        Console.Clear();
        Console.WriteLine("This is Singly Linked queue Implementation\n");
        Console.WriteLine("Press any key to continue...");
        Console.ReadKey();
        ...
        do
        {
            ...
            switch (choice)
            {
                ...
                case 2:
                    ...
                    Console.WriteLine($"Removing Node : {queue.Peek()}");
                    queue.Dequeue();
                ...
                case 3:
                    ...
                    Console.WriteLine($"Current Node Is : {queue.Peek()}");
                ...
                case 5:
                    ...
                    Console.WriteLine($"Total Size Of Queue: {queue.Size()}");
